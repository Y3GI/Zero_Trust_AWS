...
# E2E TESTING: VPC module deployed third
# Creates network infrastructure: VPC, subnets, route tables, NAT gateway
# Other modules reference this state via local backend
